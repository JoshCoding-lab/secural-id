          ...
          >
            ...
            >
              ...
              <motion.button 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-transparent border-2 border-white/30 text-white font-semibold px-8 py-3 rounded-full hover:bg-white/10 hover:border-white/50 transition-all duration-300"
              >
    ...
    >
      {anggota.map((orang, index) => (
        <motion.div
          key={index}
          variants={itemVariants}
          className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-500 hover:shadow-2xl hover:scale-105"
        >
          {/* FOTO YANG BESAR & DOMINAN */}
...
<div className="p-6 bg-gray-50 text-center">
  <h3 className="text-lg font-semibold text-gray-900">{orang.nama}</h3>
  <p className="text-blue-700 font-medium mt-1">{orang.Jobdeks}</p>
  <p className="text-sm text-gray-500 italic mt-2">{orang.asal}</p>
</div>
      ...
      <section className="bg-blue-50 py-24 sm:py-32">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left mt-10">
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-2 transform transition-all duration-300 border border-blue-100">
  ...
  <span className="flex items-center gap-2">
    ...
    <span className="text-blue-400">ID</span>
          ...
          <div className="text-sm text-gray-500 border-t border-gray-800 pt-8 mt-8 tracking-wide">
